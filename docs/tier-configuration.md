...
Paid tiers use the snapshotted creator price for Stripe authorization before queue admission and capture after host selection. A creator must finish Stripe payout onboarding before starting a Hotline with any enabled paid tier. The creator receives 80% of the call price less half of the published basic card-processing fee. Bling retains 20% and pays the other half of that fee. See [payments.md](payments.md).
